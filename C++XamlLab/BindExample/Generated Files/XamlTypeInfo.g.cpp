...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"BindExample.MainPage")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::BindExample::MainPage(); 
            };
        return userType;
    }

    if (typeName == L"BindExample.Person")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::BindExample::Person(); 
            };
        userType->AddMemberName(L"Phone");
...
{
    if (longMemberName == L"BindExample.Person.Phone")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"Phone", L"String");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::BindExample::Person^)instance;
                return that->Phone;
            };
        ...
        xamlMember->Setter =
            ...
            {
                auto that = (::BindExample::Person^)instance;
                that->Phone = (::Platform::String^)value;
            };
        return xamlMember;
    }

    if (longMemberName == L"BindExample.Person.Name")
    {
